...
{   
	...
	printf("Number of Faculty who have requested for queries: ");  	
	scanf("%d",&faculty_num);
	for(i=1;i<=faculty_num;i++)
	{
		printf("Enter name of faculty%d: ",i);
		scanf("%s",&f[i].faculty_name);
		printf("Enter  faculty time %d: ",i);				
	...
	printf("Number of Students who have requested for queries: ");  	
	scanf("%d",&student_num);
	for(i=1;i<=student_num;i++)
	{
		printf("Enter name of student%d: ",i);
		scanf("%s",&s[i].student_name);
		printf("Enter  Student time %d: ",i);			
	...
	printf("\n\nThe total time spent for query = %d",total);
	printf("\n Average time spent for query = %d",avg);
